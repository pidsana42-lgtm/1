...
```
สคริปต์นี้จะช่วย:
- **Multi-turn RAG Simulation**: จำลองการป้อนเอกสาร Context ในคำถามรอบแรก และรอบที่สองเป็นคำถามต่อยอดเจาะลึกที่ไม่มี Context ซ้ำ เพื่อเทรนให้โมเดลจำประวัติบริบทได้ข้ามเทิร์น
