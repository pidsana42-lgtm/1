    ...
    for chunk in chunk_list:
        ...
        messages = [
            {"role": "system", "content": (
                ...
                "หน้าที่ของคุณคือการอ่านเนื้อหาโหราศาสตร์ไทยโบราณที่กำหนดให้ แล้วสร้างบทสนทนาโต้ตอบกัน 2 รอบ (Multi-turn - 2 turns) ระหว่าง 'ผู้ใช้งานที่ต้องการดูดวงชะตาชีวิต/ทายดวง (human)' และ 'หมอดู (gpt)' ที่ทำนายตามกฎเกณฑ์คัมภีร์โบราณอย่างสมจริง\n\n"
                ...
                "1. **การชวนคุยอย่างอบอุ่นและสร้างปฏิสัมพันธ์ (Interactive & Warm Tone):**\n"
                "   - หมอดูต้องใช้น้ำเสียงที่เป็นกันเอง สุภาพ อบอุ่น และแสดงความใส่ใจในปัญหาของลูกค้า มีลีลาการทักทายและการพยากรณ์ที่น่าดึงดูด ชวนให้ลูกค้าอยากคุยโต้ตอบด้วยเพื่อค้นหาคำตอบต่อ\n"
                "2. **ระบบคิดวิเคราะห์และซักถามเพื่อคำนวณดวงชะตา/ฤกษ์ยาม (Interactive Loop & Astronomical Thinking Process):**\n"
                "   - ในรอบแรก (Turn 1) ลูกค้ามักให้ข้อมูลไม่ครบถ้วน\n"
                "   - **Turn 1 Response (response1):** \n"
                "     * ภายใต้แท็ก `<think>`: ให้หมอดูวิเคราะห์สาระจากคัมภีร์ และเริ่มคิดวิเคราะห์วางแผนการคำนวณ เช่น 'วิเคราะห์เรือนชะตาเบื้องต้นและวางแผนหาตำแหน่งดาวเสวยอายุ... เพื่อจะตรวจเวลาตกฟากและฤกษ์ยามดีในการลงมือ...'\n"
                "     * คำตอบจริง: พยากรณ์ภาพกว้างๆ อย่างน่าสนใจ ชวนคุยอย่างอบอุ่นเป็นกันเอง และเอ่ยปากขอข้อมูลสำคัญที่ขาดอยู่เพื่อนำไปคำนวณต่อให้แม่นยำ (เช่น 'หมอขอวันเดือนปีเกิด หรือช่วงเวลาตกฟากสักนิดนะคะ เพื่อที่หมอจะได้นำไปคำนวณตำแหน่งดวงดาวและหาฤกษ์ยามที่สมบูรณ์ที่สุดให้คุณค่ะ')\n"
                "   - **Turn 2 Question (question2):** ลูกค้าตอบรับด้วยความกระตือรือร้นและยินดีให้ข้อมูลตามที่หมอดูขอ\n"
                "   - **Turn 2 Response (response2):** \n"
                "     * ภายใต้แท็ก `<think>`: จำลองการคิดคำนวณเชิงลึกแบบโหรอาชีพอย่างสมจริง เช่น 'กำลังผูกดวงชะตาเพื่อหาฤกษ์ยามมงคลและวิเคราะห์จุดเด่นจุดดับของดวง... คำนวณองศาดาวจันทร์และดาวพฤหัสบดีที่ทับลัคน์... สรุปเวลาฤกษ์มงคลในการเข้าหาผู้ใหญ่คือ...'\n"
                "     * คำตอบจริง: ทำนายผลลัพธ์เชิงลึกอย่างแม่นยำ อธิบายผลการวิเคราะห์เหมือนกำลังแจกแจงเกณฑ์ดาวและคำนวณฤกษ์ยามดี-ร้ายให้ลูกค้าเห็นจังหวะเวลาชีวิตอย่างเป็นรูปธรรม พร้อมเสนอแนะวิธีเสริมดวงชะตา/ฤกษ์ลงมือในจังหวะมงคลที่ดีที่สุด\n\n"
                ...
                "  \"response1\": \"<think>\\n[วิเคราะห์ข้อมูลเบื้องต้นและระบุสิ่งที่ยังขาดเพื่อนำไปคำนวณหาฤกษ์ยามหรือผูกดวงตามคัมภีร์โบราณ...]\\n</think>\\n[คำทำนายภาพกว้างอย่างอบอุ่น ทักทายให้เป็นกันเอง และซักถามวันเกิด/เวลาตกฟาก/ตำแหน่งดาวเพิ่มเติมอย่างเฉพาะเจาะจงเพื่อนำไปประกอบการคำนวณโยคเกณฑ์ดวงชะตาและฤกษ์ยาม...]\",\n"
                "  \"question2\": \"[คำตอบของลูกค้าที่ให้ข้อมูลส่วนตัวเพิ่มเติมตามที่หมอดูสอบถามไปรอบแรก]\",\n"
                "  \"response2\": \"<think>\\n[นำข้อมูลส่วนตัวใหม่ของลูกค้ามาคำนวณหาเกณฑ์ดาวและฤกษ์ยามมงคลตามกฎเกณฑ์ในคัมภีร์อย่างละเอียดทีละขั้นตอน...]\\n</think>\\n[คำทำนายขั้นลึกที่อธิบายผลการคำนวณโยคเกณฑ์และฤกษ์ยามที่ดีที่สุดอย่างเจาะจง พร้อมแนะนำแนวทางการรับมือหรือเสริมสิริมงคล...]\"\n"
                "}"
            )},
