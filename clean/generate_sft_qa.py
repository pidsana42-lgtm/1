    ...
    for chunk in chunk_list:
        ...
        messages = [
            {"role": "system", "content": (
                ...
                "หน้าที่ของคุณคือการอ่านเนื้อหาโหราศาสตร์ไทยโบราณที่กำหนดให้ แล้วสร้างบทสนทนาโต้ตอบกัน 2 รอบ (Multi-turn - 2 turns) ระหว่าง 'ผู้ใช้งานที่ต้องการดูดวงชะตาชีวิต/ทายดวง (human)' และ 'หมอดูอัจฉริยะ (gpt)' ที่ทำนายตามกฎเกณฑ์คัมภีร์\n\n"
                "กติกาการสร้างบทสนทนา:\n"
                "1. รอบที่ 1 (Turn 1):\n"
                "   - คำถามแรก (question1): ต้องเป็นคำถามของคนดูดวงจำลองที่อยากรู้เกณฑ์ชีวิตตนเองตามคัมภีร์นี้ โดยต้องเป็นคำถามสั้นกระชับที่คนธรรมดาทั่วไปพูดคุยถามหมอดูในชีวิตจริง ห้ามใส่ข้อมูลคัมภีร์หรือ RAG Context ปนลงไปในคำถามเด็ดขาด (ตัวอย่าง: 'หมอคะ ในดวงของหนูมีดาว ๑ (อาทิตย์) อยู่ราศีพฤษภ แบบนี้ชีวิตหนูจะเป็นอย่างไรบ้างคะ?')\n"
                "   - คำตอบแรก (response1): เริ่มต้นด้วยแท็กกระบวนการคิดวิเคราะห์วิถีดวงตามตำราในแท็ก <think> และ </think> จากนั้นให้คำทำนายดวงชะตาอย่างอบอุ่น สุภาพ และมีหลักการตามเกณฑ์ของคัมภีร์เท่านั้น\n"
                "2. รอบที่ 2 (Turn 2):\n"
                "   - คำถามที่สอง (question2): เป็นคำถามต่อเนื่องของลูกค้าคนเดิมที่ถามเจาะลึกเพิ่มเติมเกี่ยวกับดวงของตนเองต่อจากรอบแรก (เช่น 'แล้วดาว ๕ ของหนูที่อยู่ร่วมเรือนเดียวกันมีข้อยกเว้นอะไรเพิ่มเติมไหมคะหมอ?', 'ช่วงนี้ต้องระวังเกณฑ์ร้ายเรื่องอะไรพิเศษบ้างคะ?') โดยต้องเป็นประโยคคำถามภาษาพูดสั้นๆ ของคนธรรมดา ไม่มีคัมภีร์ปน\n"
                "   - คำตอบที่สอง (response2): แสดงกระบวนการคิดวิเคราะห์ในแท็ก <think> และ </think> อีกครั้ง แล้วให้คำทำนายดวงชะตาเจาะลึกที่สัมพันธ์กับคำถามที่สองโดยใช้ข้อมูลจากคัมภีร์เดิม\n\n"
                "ส่งกลับเป็นโครงสร้าง JSON ดังนี้เท่านั้น ห้ามพิมพ์อย่างอื่นขยายนอก JSON:\n"
                "{\n"
                "  \"question1\": \"[คำถามดูดวงรอบแรกของคนธรรมดา ไม่ปนคัมภีร์]\",\n"
                "  \"response1\": \"<think>\\n[วิเคราะห์ดวงชะตาและเรียบเรียงคำทำนายตามคัมภีร์โบราณทีละขั้นตอน...]\\n</think>\\n[คำทำนายของหมอดูที่อบอุ่นตามเกณฑ์คัมภีร์...]\",\n"
                "  \"question2\": \"[คำถามดูดวงรอบสองของลูกค้าที่ถามต่อจากรอบแรก]\",\n"
                "  \"response2\": \"<think>\\n[วิเคราะห์เกณฑ์ดวงชะตาเพิ่มเติมจากคำถามรอบสองทีละขั้นตอน...]\\n</think>\\n[คำทำนายเจาะลึกรอบสองตามเกณฑ์คัมภีร์...]\"\n"
                "}"
            )},
