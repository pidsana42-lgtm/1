    ...
    for chunk in chunk_list:
        ...
        messages = [
            {"role": "system", "content": (
                ...
                "3. มีการระบุ 'ข้อมูลพื้นฐาน/สถานการณ์สั้นๆ (Background Scenario)' เพื่อปูพื้นหลังให้สมจริง เช่น 'เพิ่งย้ายงานใหม่', 'เพิ่งเลิกกับแฟน', 'สัมภาษณ์งานไปแล้วกำลังรอผล', 'ช่วงนี้หมดไฟมาก' ฯลฯ\n"
                ...
                "กติกาในการตอบของหมอดู (GPT):\n"
                "1. เริ่มต้นคำตอบด้วยกระบวนการคิดวิเคราะห์ดวงชะตาและการคำนวณตามหลักคัมภีร์และข้อมูลที่ลูกค้าบอกมา ภายใต้แท็ก <think> และ </think> (วิเคราะห์แบบละเอียดสมบูรณ์)\n"
                "2. ให้คำทำนายตามกฎเกณฑ์คัมภีร์อย่างอบอุ่น สุภาพ ไพเราะ และชี้แนะแนวทางอย่างเป็นรูปธรรม\n"
                "3. การโต้ตอบมี 2 รอบ (Turn 1 และ Turn 2):\n"
                "   - Turn 1 (question1 -> response1): คำถามยอดฮิตที่ตรงตามบริบทคัมภีร์พร้อมระบุเวลาและบริบทชีวิต + คำตอบพร้อม <think>\n"
                "   - Turn 2 (question2 -> response2): ลูกค้าถามต่อเนื่องเจาะลึกเพิ่มเติมจากคำตอบรอบแรกด้วยภาษาเป็นธรรมชาติ (เช่น 'มีจุดไหนที่หนูต้องปรับปรุงตัวเองเป็นพิเศษตามเกณฑ์นี้ไหมคะ?', 'ถ้าหนูอยากเสริมดวงในเรื่องการงานนี้ หมอแนะนำวิธีไหนดีคะ?') + คำตอบเจาะลึกรอบสองพร้อม <think>\n\n"
                "ส่งกลับเป็นโครงสร้าง JSON ดังนี้เท่านั้น ห้ามพิมพ์อธิบายขยายนอก JSON:\n"
                "{\n"
                "  \"question1\": \"[คำถามดูดวงรอบแรกของคนธรรมดา ระบุบริบทสั้นๆ และกรอบเวลา ไม่ปนข้อความคัมภีร์]\",\n"
                "  \"response1\": \"<think>\\n[วิเคราะห์ดวงชะตาและคำนวณคำทำนายจากข้อความคัมภีร์โบราณอย่างละเอียดทีละขั้นตอน...]\\n</think>\\n[คำทำนายของหมอดูที่อบอุ่น อิงกฎเกณฑ์คัมภีร์ และชี้แนวทางอย่างเป็นมิตร...]\",\n"
                "  \"question2\": \"[คำถามชวนคุยเจาะลึก/ถามต่อของลูกค้าจากคำตอบรอบแรกอย่างเป็นธรรมชาติ]\",\n"
                "  \"response2\": \"<think>\\n[วิเคราะห์ข้อมูลคัมภีร์เพิ่มเติมเพื่อตอบคำถามรอบสอง...]\\n</think>\\n[คำทำนายเจาะลึกพร้อมคำแนะนำเสริมดวงชะตารอบสองตามเกณฑ์คัมภีร์โบราณ...]\"\n"
                "}"
            )},
