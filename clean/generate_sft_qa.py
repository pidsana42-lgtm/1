    ...
    for chunk in chunk_list:
        ...
        messages = [
            {"role": "system", "content": (
                ...
                "1. รอบที่ 1 (Turn 1):\n"
                "   - คำถามแรก (question1): ต้องนำเสนอ RAG Context เป็นข้อมูลคัมภีร์นำมาก่อน แล้วตามด้วยคำถามของผู้ใช้ที่สมมติว่าตนเองต้องการดูดวงชะตาชีวิตหรือถามทายทิศทางดวงชะตาตามหลักวิชาในคัมภีร์นี้ ตัวอย่าง:\n"
                "     \"ข้อมูลประกอบคำตอบ:\n"
                "     ---\n"
                "     [เนื้อหาคัมภีร์ที่กำหนดให้]\n"
                "     ---\n"
                "     คำถาม: หมอคะ ในดวงของหนูมีดาว ๑ (อาทิตย์) อยู่ในเกณฑ์เดียวกันกับที่ระบุด้านบนนี้เลย แบบนี้ชีวิตหนูจะส่งผลดีร้ายในด้านใดบ้างคะ?\"\n"
                ...
                "2. รอบที่ 2 (Turn 2):\n"
                "   - คำถามที่สอง (question2): เป็นคำถามต่อเนื่องของลูกค้าคนเดิมที่ถามเจาะลึกเพิ่มเติมเกี่ยวกับดวงของตนเองต่อจากรอบแรก (เช่น 'แล้วดาว ๕ ของหนูที่อยู่ร่วมเรือนเดียวกันมีข้อยกเว้นอะไรเพิ่มเติมไหมคะหมอ?', 'ช่วงนี้ต้องระวังเกณฑ์ร้ายเรื่องอะไรพิเศษบ้างคะ?')\n"
                ...
                "{\n"
                "  \"question1\": \"ข้อมูลประกอบคำตอบ:\\n---\\n[RAG Context]\\n---\\nคำถาม: [คำถามดูดวงรอบแรก]\",\n"
                "  \"response1\": \"<think>\\n[วิเคราะห์ดวงชะตาและเรียบเรียงคำทำนายอย่างเป็นขั้นตอน...]\\n</think>\\n[คำทำนายของหมอดูที่อบอุ่นตามคัมภีร์...]\",\n"
                "  \"question2\": \"[คำถามดูดวงรอบสองของลูกค้าที่ถามต่อจากรอบแรก]\",\n"
                "  \"response2\": \"<think>\\n[วิเคราะห์เกณฑ์ดวงชะตาเพิ่มเติมทีละขั้นตอน...]\\n</think>\\n[คำทำนายเจาะลึกรอบสองตามคัมภีร์...]\"\n"
                "}"
            )},
