#!/bin/bash
# สคริปต์รัน clean/generate_sft_qa.py สำหรับสังเคราะห์ชุดคำถาม-คำตอบเพื่อทำ SFT
...
echo "🚀 Starting synthetic QA SFT dataset generation pipeline..."
python3 clean/generate_sft_qa.py "$@"
